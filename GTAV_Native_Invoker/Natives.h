...
opd_s _APPLY_FORCE_TO_ENTITY_ALT = { 0x3AF3F8, TOC };
...
opd_s GET_PED_LAST_WEAPON_IMPACT_COORD_t = { 0x468ED0, TOC };
bool(*__GET_PED_LAST_WEAPON_IMPACT_COORD)(int Ped, float*Co) = (bool(*)(int, float*))&GET_PED_LAST_WEAPON_IMPACT_COORD_t;

namespace PLAYER
{
	static Ped PLAYER_PED_ID3() { return invoke<Ped>(0xFA92E226); } // 0xFA92E226 0xFA92E226
	...
	static Ped PLAYER_PED_ID2() { return invoke<Ped>(0xFA92E226); } // 0xFA92E226
...
namespace ENTITY
{
	...
	static Vector3 GET_ENTITY_COORDS2(Entity entity, BOOL alive) { return invoke<Vector3>(0x1647F1CB, entity, alive); } // 0x1647F1CB
	...
	static int GET_ENTITY_HEALTH2(Entity entity) { return invoke<int>(0x8E3222B7, entity); } // 0x8E3222B7
	...
	static Hash GET_ENTITY_MODEL2(Entity entity) { return invoke<Hash>(0xDAFCB3EC, entity); } // 0xDAFCB3EC
	...
	static Vector3 GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS_1(Entity Entity, int xCoord, int yCoord, int zCoord) { return invoke<Vector3>(0xABCF043A, Entity, xCoord, yCoord, zCoord); } // 0xABCF043A
	...
	static Vector3 GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS2(Entity entity, float xOffset, float yOffset, float zOffset) { return invoke<Vector3>(0xABCF043A, entity, xOffset, yOffset, zOffset); } // 0xABCF043A
	...
	static Any PLAY_ENTITY_ANIM(Any p0, char* p1, char* p2, float p3, bool p4, bool p5, bool p6, float p7, Any p8) { return invoke<Any>(0x878753D5, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0x878753D5
	...
	static void SET_ENTITY_COLLISION1(Entity entity, BOOL p1) { invoke<Void>(0x139FD37D, entity, p1); } // 0x139FD37D
	...
	static void SET_ENTITY_COORDS_1(Entity entity, float X, float Y, float Z, BOOL XAxes, BOOL YAxes, BOOL ZAxes, BOOL unk) { invoke<Void>(0xDF70B41B, entity, X, Y, Z, XAxes, YAxes, ZAxes, unk); } // 0xDF70B41B
...
namespace PED
{
	static Ped GET_CLOSEST_PED_1(float x, float y, float z, float Radius, BOOL p4, BOOL p5, int* handle, BOOL p7, BOOL p8, int p9) { return invoke<Ped>(0x8F6C1F55, x, y, z, Radius, p4, p5, handle, p7, p8, p9); } // 0x8F6C1F55
	...
	static BOOL IS_PED_IN_ANY_VEHICLE2(Ped ped, BOOL atGetIn) { return invoke<BOOL>(0x3B0171EE, ped, atGetIn); } // 0x3B0171EE
	...
	static Vehicle GET_VEHICLE_PED_IS_IN2(Ped ped, BOOL getLastVehicle) { return invoke<Vehicle>(0xAFE92319, ped, getLastVehicle); } // 0xAFE92319
	...
	static int GET_PED_ARMOUR2(Ped ped) { return invoke<int>(0x2CE311A7, ped); } // 0x2CE311A7
	...
	static void SET_PED_STEALTH_MOVEMENT(Any p0, bool p1, char *p2) { invoke<Void>(0x67E28E1D, p0, p1, p2); } // 0x67E28E1D
	...
	static void SET_PED_MOVEMENT_CLIPSET(Any p0, char* p1, float p2) { invoke<Void>(0xA817CDEB, p0, p1, p2); } // 0xA817CDEB
	...
	static void SET_PED_USING_ACTION_MODE(Any p0, Any p1, Any p2, char *p3) { invoke<Void>(0x8802F696, p0, p1, p2, p3); } // 0x8802F696
...
namespace VEHICLE
{
	...
	static char *GET_DISPLAY_NAME_FROM_VEHICLE_MODEL2(Hash modelHash) { return invoke<char*>(0xEC86DF39, modelHash); } // 0xEC86DF39
	...
	static int GET_VEHICLE_CLASS2(Vehicle vehicle) { return invoke<int>(0xC025338E, vehicle); } // 0xC025338E
...
namespace OBJECT
{
	...
	static Any CREATE_AMBIENT_PICKUP2(Hash pickupHash, float posX, float posY, float posZ, int p4, int value, Hash modelHash, BOOL p7, BOOL p8) { return invoke<Any>(0x17B99CE7, pickupHash, posX, posY, posZ, p4, value, modelHash, p7, p8); } // 0x17B99CE7 0x17B99CE7
	...
	static Any CREATE_AMBIENT_PICKUP_1(Hash AmbientHash, float* XCoord, float* YCoord, float* ZCoord, int p4, int amount, int modelHash, BOOL p7, BOOL p8) { return invoke<Any>(0x17B99CE7, AmbientHash, XCoord, YCoord, ZCoord, p4, amount, modelHash, p7, p8); } // 0x17B99CE7
...
namespace AI
{
	...
	static void TASK_PLAY_ANIM2(Ped PedHandle, char* AnimSet, char* AnimationName, float Speed, float unk, int Loop, int LastAnimation, float PlaybackRate, BOOL xLock, BOOL yLock, BOOL zLock) { invoke<Void>(0x5AB552C6, PedHandle, AnimSet, AnimationName, Speed, unk, Loop, LastAnimation, PlaybackRate, xLock, yLock, zLock); } // 0x5AB552C6
	...
	static void SET_ANIM_RATE(Any p0, float p1, Any p2, Any p3) { invoke<Void>(0x6DB46584, p0, p1, p2, p3); } // 0x6DB46584
...
namespace GAMEPLAY
{
	...
	static float GET_DISTANCE_BETWEEN_COORDS2(float x1, float y1, float z1, float x2, float y2, float z2, BOOL unknown) { return invoke<float>(0xF698765E, x1, y1, z1, x2, y2, z2, unknown); } // 0xF698765E
	...
	static int GET_HASH_KEY2(const char* ToHash) { return invoke<int>(0x98EFF6F1, ToHash); } // 0x98EFF6F1
	...
	static void SHOOT_SINGLE_BULLET_BETWEEN_COORDS_2(float StartPositionX, float StartPositionY, float StartPositionZ, float HitPositionX, float HitPositionY, float HitPositionZ, Any p6, Any p7, Hash WeaponHash, Ped PedHandle, Any p10, Any p11, float Speed) { invoke<Void>(0xCB7415AC, StartPositionX, StartPositionY, StartPositionZ, HitPositionX, HitPositionY, HitPositionZ, p6, p7, WeaponHash, PedHandle, p10, p11, Speed); } // 0xCB7415AC
...
namespace CAM
{
	...
	static float GET_GAMEPLAY_CAM_RELATIVE_PITCH() { return invoke<float>(0xFC5A4946); } // 0xFC5A4946
...
namespace WEAPON
{
	...
	static BOOL GET_CURRENT_PED_WEAPON2(Ped ped, Hash* weaponHash, BOOL p2) { return invoke<BOOL>(0xB0237302, ped, weaponHash, p2); } // 0xB0237302
	...
	static BOOL IS_PED_ARMED2(Ped ped, int p1) { return invoke<BOOL>(0x0BFC892C, ped, p1); } // 0x0BFC892C
	...
	static BOOL GET_PED_LAST_WEAPON_IMPACT_COORD_2(Ped ped, Vector3 &coords) { float tmp[100]; BOOL hasHit = GPLWIC(ped, 0x10030000); for (int i = 0; i < 3; i++) tmp[i] = *(float*)(0x10030000 + (i * 0x04)); Vector3 vOut = FloatToVector(tmp[0], tmp[1], tmp[2]);  coords = vOut; return hasHit; } //  0x9B266079
...
namespace SCRIPT
{
	...
	static void TRIGGER_SCRIPT_EVENT_1(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x54763B35, p0, p1, p2, p3); } // 0x54763B35
...
namespace GRAPHICS
{
	...
	static BOOL START_PARTICLE_FX_NON_LOOPED_ON_ENTITY(char* p0, Entity p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8, BOOL p9, BOOL p10, BOOL p11) { return invoke<BOOL>(0x9604DAD4, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); } // 0x9604DAD4
	...
	static void DRAW_LIGHT_WITH_RANGE_1(float XCoord, float YCoord, float ZCoord, int Red, int Green, int Blue, float Width, float Height) { invoke<Void>(0x6A396E9A, XCoord, YCoord, ZCoord, Red, Green, Blue, Width, Height); } // 0x6A396E9A
	...
	static Any START_PARTICLE_FX_LOOPED_AT_COORD(char* p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11) { return invoke<Any>(0xD348E3E6, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); } // 0xD348E3E6
	static int START_PARTICLE_FX_LOOPED_ON_PED_BONE(char* p0, Ped p1, float p2, float p3, float p4, float p5, float p6, float p7, int p8, float p9, BOOL p10, BOOL p11, BOOL p12) { return invoke<int>(0xF8FC196F, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12); } // 0xF8FC196F
	...
	static void DRAW_MARKER3(int type, float x, float y, float z, float dirX, float dirY, float dirZ, float rotX, float rotY, float rotZ, float scaleX, float scaleY, float scaleZ, Any colorR, Any colorG, Any colorB, int alpha, BOOL bobUpAndDown, BOOL faceCamera, int p19, BOOL rotate, char *textureDict, char *textureName, BOOL drawOnEnts) { invoke<Void>(0x48D84A02, type, x, y, z, dirX, dirY, dirZ, rotX, rotY, rotZ, scaleX, scaleY, scaleZ, colorR, colorG, colorB, alpha, bobUpAndDown, faceCamera, p19, rotate, textureDict, textureName, drawOnEnts); } // 0x48D84A02
}
...
namespace PATHFIND
{
	...
	static void GET_STREET_NAME_AT_COORD(Any p0, Any p1, Any p2, Hash *p3, Hash *p4) { invoke<Void>(0xDEBEEFCF, p0, p1, p2, p3, p4); } // 0xDEBEEFCF
	static void GET_STREET_NAME_AT_COORD2(float x, float y, float z, Hash *streetName, Hash *crossingRoad) { invoke<Void>(0xDEBEEFCF, x, y, z, streetName, crossingRoad); } // 0xDEBEEFCF
...
namespace NETWORK
{
	...
	static Any NETWORK_SEND_TEXT_MESSAGE2(char* Text, int FreeMemPointer) { return invoke<Any>(0xAFFEA720, Text, FreeMemPointer); } // 0xAFFEA720
	...
	static BOOL NETWORK_IS_PLAYER_ACTIVE2(Player player) { return invoke<BOOL>(0x43657B17, player); } // 0x43657B17
	...
	static int NETWORK_GET_HOST_OF_SCRIPT_1(char* gamemode, Any p1, Any p2) { return invoke<int>(0x9C95D0BB, gamemode, p1, p2); } // 0x9C95D0BB 0x9C95D0BB
	...
	static void NETWORK_HANDLE_FROM_PLAYER2(Ped PedHandle, int FreeMemPointer, int p2) { invoke<Void>(0xD3498917, PedHandle, FreeMemPointer, p2); }
	...
	static char* NETWORK_IS_FRIEND_ONLINE2(char* p0) { return invoke<char*>(0xE0A42430, p0); } // 0xE0A42430
	...
	static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE_3(Ped player, int scene, char* anim, char* animid, float speed, float speedmul, int duration, int flag, float playbackr, Any p9) { invoke<Void>(0xB386713E, player, scene, anim, animid, speed, speedmul, duration, flag, playbackr, p9); } // 0xB386713E
...
static void REMOVE_WEAPON_FROM_PED(Ped Handle, Hash WeaponHash) { invoke<Void>(0x9C37F220, Handle, WeaponHash); } // 0x9C37F220
static Any NETWORK_CREATE_SYNCHRONISED_SCENE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11) { return invoke<Any>(0xB06FE3FE, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); } // 0xB06FE3FE
...
static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE2(Ped ped, int sceneId, char *animDictionary, char *animationName, float speed, float speedMultiplier, int duration, int flag, float playbackRate) { invoke<Void>(0xB386713E, ped, sceneId, animDictionary, animationName, speed, speedMultiplier, duration, flag, playbackRate); } // 0xB386713E
static void NETWORK_START_SYNCHRONISED_SCENE(Any p0) { invoke<Void>(0xA9DFDC40, p0); } // 0xA9DFDC40
opd_s create_ambient_pickup_t = { 0x3FA674, TOC };
void(*__CREATE_AMBIENT_PICKUP)(uint hash, Vector3 *c, int Zero, int Amount, int One, int Zeroo, int Onee) = (void(*)(uint, Vector3 *c, int, int, int, int, int))&create_ambient_pickup_t;

opd_s __DRAW_YEXT_t = { 0x3D6570, TOC };
BOOL(*__DRAW_YEXT)(float x, float y) = (BOOL(*)(float, float))&__DRAW_YEXT_t;
...
#define TOC (0x1C85330)
	...
	{
		//Ped ped, Vector3* coord
		opd_s native = { 0x468ED0, TOC };
...
namespace TOCCALL {
...
#ifdef BLES
	opd_s GET_PED_LAST_WEAPON_IMPACT_COORD_t = { 0x468ED0, TOC };
	opd_s GET_PED_LAST_WEAPON_IMPACT_COORD2_t = { 0x468ED0, TOC };
	opd_s GET_PED_LAST_WEAPON_IMPACT_COORD7_t = { 0x468ED0, TOC };
	opd_s PLAYER_PED_ID_t = { 0x4241A8, TOC };
	opd_s ATTACH_CAM_TO_PED_BONE_t = { 0x3A424C, TOC };
	opd_s ADD_EXPLOSION_t = { 0x3BD294, TOC };
	opd_s SET_ENTITY_COORDS_t = { 0x3B30F0, TOC };
	opd_s REQUEST_MODEL_t = { 0x435764, TOC };
	opd_s CREATE_PED_t = { 0x4049C0, TOC };
	opd_s GET_ENTITY_COORDS_t = { 0x3AB3B0, TOC };
	opd_s GET_PLAYER_PED_t = { 0x421958, TOC };
	opd_s IS_PED_IN_ANY_VEHICLE_t = { 0x405638, TOC };
	opd_s GET_VEHICLE_PED_IS_IN_t = { 0x408D38, TOC };
	opd_s GET_VEHICLE_PED_IS_IN2_t = { 0x408D38, TOC };
	opd_s NETWORK_REQUEST_CONTROL_OF_ENTITY_t = { 0x3E9F9C, TOC };
	opd_s GET_PED_LAST_WEAPON_IMPACT_COORD1_t = { 0x468ED0, TOC };
	opd_s get_player_ped_t = { 0x421958, TOC };
	opd_s IS_PED_IN_ANY_VEHICLE2_t = { 0x405638, TOC };
	opd_s GET_VEHICLE_PED_IS_USING_t = { 0x40ECAC, TOC };
	opd_s SET_PED_INTO_VEHICLE_t = { 0x40939C, TOC };
	opd_s GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS_t = { 0x44F0D8, TOC };
	opd_s IS_VEHICLE_SEAT_FREE_t = { 0x45110C, TOC };
	opd_s SET_VEHICLE_CUSTOM_PRIMARY_COLOUR_t = { 0x44FF8C, TOC };
	opd_s SET_VEHICLE_CUSTOM_SECONDARY_COLOUR_t = { 0x4501C8, TOC };
	opd_s SET_VEHICLE_NUMBER_PLATE_TEXT_t = { 0x4533DC, TOC };
	opd_s SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX_t = { 0x4534B8, TOC };
	opd_s SET_VEHICLE_WINDOW_TINT_t = { 0x45FD04, TOC };
	opd_s TOGGLE_VEHICLE_MOD_t = { 0x45F6E0, TOC };
	opd_s SET_VEHICLE_MOD_KIT_t = { 0x45EC34, TOC };
	opd_s SET_VEHICLE_TYRE_SMOKE_COLOR_t = { 0x45FC20, TOC };
	opd_s SET_VEHICLE_MOD_t = { 0x4542B0, TOC };
	opd_s SET_VEHICLE_EXTRA_t = { 0x459730, TOC };
	opd_s SET_VEHICLE_TYRES_CAN_BURST_t = { 0x451CEC, TOC };
	opd_s GET_RANDOM_INT_IN_RANGE_t = { 0x3D45CC, TOC };
	opd_s SET_VEHICLE_UNDRIVEABLE_t = { 0x4569C8, TOC };
	opd_s SET_VEHICLE_FIXED_t = { 0x459000, TOC };
	opd_s SET_ENTITY_COLLISION_t = { 0x3B2CE4, TOC };
	opd_s NETWORK_REQUEST_CONTROL_OF_ENTITY2_t = { 0x3E9F9C, TOC };
	opd_s ADD_OWNED_EXPLOSION_t = { 0x3BD39C, TOC };
	opd_s SET_ENTITY_COORDS2_t = { 0x3B30F0, TOC };
	opd_s ATTACH_ENTITY_TO_ENTITY_t = { 0x3B0018, TOC };
	opd_s CREATE_OBJECT_t = { 0x3F8E9C, TOC };
	opd_s GET_HASH_KEY_t = { 0x110C08, TOC };
	opd_s GET_ENTITY_COORDS3_t = { 0x3AB3B0, TOC };
	opd_s GET_PLAYER_PED3_t = { 0x421958, TOC };
	opd_s CREATE_OBJECT2_t = { 0x3F8E9C, TOC };
	opd_s ATTACH_ENTITY_TO_ENTITY2_t = { 0x3B0018, TOC };
	opd_s HAS_MODEL_LOADED_t = { 0x4358EC, TOC };
	opd_s REQUEST_MODEL3_t = { 0x435764, TOC };
	opd_s SET_ENTITY_COLLISION2_t = { 0x3B2CE4, TOC };
	opd_s GET_ENTITY_COORDS4_t = { 0x3AB3B0, TOC };
	opd_s GET_PED_BONE_INDEX_t = { 0x41A08C, TOC };
	opd_s DOES_ENTITY_EXIST_t = { 0x3A9FA8, TOC };
	opd_s get_player_ped2_t = { 0x421958, TOC };
	opd_s _APPLY_FORCE_TO_ENTITY_ALT_t = { 0x3AF3F8, TOC };
	opd_s GET_ENTITY_SPEED_t = { 0x3ACAF0, TOC };
	opd_s GET_VEHICLE_PED_IS_IN5_t = { 0x408D38, TOC };
	opd_s draw_line_t = { 0x3BDA20, TOC };
	opd_s draw_rect_t = { 0x3BFC28, TOC };
	opd_s APPLY_FORCE_TO_ENTITY_t = { 0x3AF3F8, TOC };
	opd_s NETWORK_REQUEST_CONTROL_OF_ENTITY2_t = { 0x3E9F9C, TOC };
	opd_s NETWORK_HAS_CONTROL_OF_ENTITY_t = { 0x3EA110, TOC };
	opd_s NETWORK_CREATE_SYNCHRONISED_SCENE99999_t = { 0x3EF460, TOC };
	opd_s NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE777_t = { 0x003EF644, TOC };
	opd_s NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE_t = { 0x3EF644, TOC };
	opd_s NETWORK_CREATE_SYNCHRONISED_SCENE_t = { 0x3EF460, TOC };
	opd_s NETWORK_START_SYNCHRONISED_SCENE_t = { 0x3EF898, TOC };
	opd_s NETWORK_STOP_SYNCHRONISED_SCENE_t = { 0x3EF8E8, TOC };
	opd_s NETWORK_CREATE_SYNCHRONISED_SCENE999999_t = { 0x3EF460, TOC };
	opd_s NETWORK_CREATE_SYNCHRONISED_SCENE9999_t = { 0x3EF460, TOC };
	opd_s NETWORK_CREATE_SYNCHRONISED_SCENE7_t = { 0x3EF460, TOC };
	opd_s NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE7_t = { 0x3EF644, TOC };
	opd_s NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE8_t = { 0x3EF644, TOC };
	opd_s NETWORK_CREATE_SYNCHRONISED_SCENE123_t = { 0x3EF460, TOC };
	opd_s SET_ENTITY_COORDS7_t = { 0x3B30F0, TOC };
	opd_s REQUEST_ANIM_DICT_t = { 0x435D2C, TOC };
	opd_s HAS_ANIM_DICT_LOADED_t = { 0x435DC4, TOC };
	opd_s DISPLAY_ONSCREEN_KEYBOARD_t = { 0x3D95BC, TOC };
	opd_s SET_ENTITY_COORDS777_t = { 0x3B30F0, TOC };
	opd_s GET_PED_LAST_WEAPON_IMPACT_COORD777_t = { 0x468ED0, TOC };
	opd_s CREATE_OBJECT777_t = { 0x3F8E9C, TOC };
	opd_s GET_HASH_KEY777_t = { 0x110C08, TOC };
	opd_s _GET_ENTITY_BONE_INDEX_t = { 0x3B05A8, TOC };
	opd_s APPLY_FORCE_TO_ENTITY_t = { 0x3AF3F8, TOC };
#else
	opd_s GET_PED_LAST_WEAPON_IMPACT_COORD_t = { 0x468ED0, TOC };
	opd_s GET_PED_LAST_WEAPON_IMPACT_COORD2_t = { 0x468ED0, TOC };
	...
	opd_s draw_rect_t = { 0x3BFC28, TOC };
	opd_s APPLY_FORCE_TO_ENTITY_t = { 0x3AF3F8, TOC };
	opd_s NETWORK_REQUEST_CONTROL_OF_ENTITY3_t = { 0x3E9F9C, TOC };
	opd_s NETWORK_HAS_CONTROL_OF_ENTITY_t = { 0x3EA110, TOC };
	...
	opd_s NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE_t = { 0x003EF644, TOC };
	opd_s NETWORK_CREATE_SYNCHRONISED_SCENE_t = { 0x3EF460, TOC };
	opd_s NETWORK_START_SYNCHRONISED_SCENE_t = { 0x3EF898, TOC };
	opd_s NETWORK_STOP_SYNCHRONISED_SCENE_t = { 0x3EF8E8, TOC };
	...
	opd_s GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS1_t = { 0x3AC394, TOC };
	opd_s GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS2_t = { 0x3AC394, TOC };

	opd_s NETWORK_CREATE_SYNCHRONISED_SCENE999999xx_t = { 0x3EF460, TOC };
	opd_s DISPLAY_ONSCREEN_KEYBOARD_t = { 0x3D95BC, TOC };
	opd_s SET_ENTITY_COORDS777_t = { 0x3B30F0, TOC };
	opd_s GET_PED_LAST_WEAPON_IMPACT_COORD777_t = { 0x468ED0, TOC };
	opd_s CREATE_OBJECT777_t = { 0x3F8E9C, TOC };
	opd_s GET_HASH_KEY777_t = { 0x110C08, TOC };
	opd_s _GET_ENTITY_BONE_INDEX_t = { 0x3B05A8, TOC };
	opd_s ATTACH_ENTITY_t = { 0x3B0018, TOC };
	opd_s ATTACH_ENTITY2_t = { 0x3B0018, TOC };
	opd_s ATTACH_ENTITY3_t = { 0x3B0018, TOC };
	opd_s APPLY_FORCE_TO_ENTITY2_t = { 0x3AF3F8, TOC };
	opd_s APPLY_FORCE_TO_ENTITY3_t = { 0x3AF3F8, TOC };
	opd_s get_vehicle_ped_is_in_t = { 0x408D38, TOC };


#endif 
	bool(*GET_PED_LAST_WEAPON_IMPACT_COORD)(int ped, Vector3 * coords) = (bool(*)(int, Vector3 *))&GET_PED_LAST_WEAPON_IMPACT_COORD_t;




	bool(*GET_PED_LAST_WEAPON_IMPACT_COORD1)(int Ped, float*Co) = (bool(*)(int, float*))&GET_PED_LAST_WEAPON_IMPACT_COORD1_t;
	int(*PLAYER_PED_ID)() = (int(*)())&PLAYER_PED_ID_t;
	void(*ATTACH_CAM_TO_PED_BONE)(int cam, int Ped, int boneid, Vector3 *Pos, bool unk) = (void(*)(int, int, int, Vector3 *Pos, bool))&ATTACH_CAM_TO_PED_BONE_t;
	void(*ADD_EXPLOSION)(Vector3 *pos, int type, float dist, bool a, bool b, float c) = (void(*)(Vector3 *pos, int, float, bool, bool, float))&ADD_EXPLOSION_t;
	void(*SET_ENTITY_COORDS)(int id, Vector3 *c, int zero, int _zero, int zero_, int one) = (void(*)(int, Vector3 *c, int, int, int, int))&SET_ENTITY_COORDS_t;
	void(*REQUEST_MODEL)(uint32_t Hash) = (void(*)(uint32_t))&REQUEST_MODEL_t;
	int(*CREATE_PED)(int e, int hash, Vector3 *Coords, float a, int b, int c) = (int(*)(int, int, Vector3 *Coords, float, int, int))&CREATE_PED_t;
	Vector3(*GET_ENTITY_COORDS)(int id, bool) = (Vector3(*)(int, bool))&GET_ENTITY_COORDS_t;
	uint(*GET_PLAYER_PED)(int Player) = (uint(*)(int))&GET_PLAYER_PED_t;
	bool(*IS_PED_IN_ANY_VEHICLE)(uint pedid, int Zero) = (bool(*)(uint, int))&IS_PED_IN_ANY_VEHICLE_t;
	uint(*GET_VEHICLE_PED_IS_IN)(uint PedID, int Zero) = (uint(*)(uint, int))&GET_VEHICLE_PED_IS_IN_t;
	bool(*NETWORK_REQUEST_CONTROL_OF_ENTITY)(int Entity) = (bool(*)(int))&NETWORK_REQUEST_CONTROL_OF_ENTITY_t;
	int(*get_player_ped)(int index) = (int(*)(int))&get_player_ped_t;
	bool(*IS_PED_IN_ANY_VEHICLE2)(int ped) = (bool(*)(int))&IS_PED_IN_ANY_VEHICLE2_t;
	int(*GET_VEHICLE_PED_IS_USING)(int PLAYER_ID) = (int(*)(int))&GET_VEHICLE_PED_IS_USING_t;
	int(*SET_PED_INTO_VEHICLE)(int PedID, int VehID, int seat) = (int(*)(int, int, int))&SET_PED_INTO_VEHICLE_t;
	bool(*GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS)(int p0) = (bool(*)(int))&GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS_t;
	bool(*IS_VEHICLE_SEAT_FREE)(int p0, int p1) = (bool(*)(int, int))&IS_VEHICLE_SEAT_FREE_t;
	int(*GET_VEHICLE_PED_IS_IN2)(int entity) = (int(*)(int))&GET_VEHICLE_PED_IS_IN2_t;
	int(*set_vehicle_custom_primary_colour)(int vehicleID, int red, int green, int blue) = (int(*)(int, int, int, int))&SET_VEHICLE_CUSTOM_PRIMARY_COLOUR_t;
	int(*set_vehicle_custom_secondary_colour)(int vehicleID, int red, int green, int blue) = (int(*)(int, int, int, int))&SET_VEHICLE_CUSTOM_SECONDARY_COLOUR_t;
	void(*set_vehicle_number_plate_text)(int vehicleID, const char* TextString) = (void(*)(int, const char*))&SET_VEHICLE_NUMBER_PLATE_TEXT_t;
	void(*set_vehicle_number_plate_text_index)(int vehicleID, int plateindex) = (void(*)(int, int))&SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX_t;
	void(*SET_VEHICLE_WINDOW_TINT)(int Vehid, int tintIndex) = (void(*)(int, int))&SET_VEHICLE_WINDOW_TINT_t;
	void(*TOGGLE_VEHICLE_MOD)(int Vehid, int modtype, int activate) = (void(*)(int, int, int))&TOGGLE_VEHICLE_MOD_t;
	void(*SET_VEHICLE_MOD_KIT)(int Vehid, int a) = (void(*)(int, int))&SET_VEHICLE_MOD_KIT_t;
	void(*SET_VEHICLE_TYRE_SMOKE_COLOR)(int Vehid, int r, int g, int b) = (void(*)(int, int, int, int))&SET_VEHICLE_TYRE_SMOKE_COLOR_t;
	void(*SET_VEHICLE_MODKIT)(int Vehid, int t) = (void(*)(int, int))&SET_VEHICLE_MOD_KIT_t;
	void(*SET_VEHICLE_MOD)(int vehicleID, int modtype, int modindex) = (void(*)(int, int, int))&SET_VEHICLE_MOD_t;
	void(*SET_VEHICLE_EXTRA)(int vehicleID, int modtype, int modindex) = (void(*)(int, int, int))&SET_VEHICLE_EXTRA_t;
	void(*SET_VEHICLE_TYRES_CAN_BURST)(int vehicleID, int toggle) = (void(*)(int, int))&SET_VEHICLE_TYRES_CAN_BURST_t;
	int(*GET_RANDOM_INT_IN_RANGE)(int lowest, int highest) = (int(*)(int, int))&GET_RANDOM_INT_IN_RANGE_t;
	void(*SET_VEHICLE_UNDRIVEABLE)(int Vehid, int activate) = (void(*)(int, int))&SET_VEHICLE_UNDRIVEABLE_t;
	void(*set_vehicle_fixed)(int vehicleID) = (void(*)(int))&SET_VEHICLE_FIXED_t;
	void(*SET_ENTITY_COLLISION)(int Vehid, bool toggle) = (void(*)(int, bool))&SET_ENTITY_COLLISION_t;
	void(*NETWORK_REQUEST_CONTROL_OF_ENTITY2)(int entity) = (void(*)(int))&NETWORK_REQUEST_CONTROL_OF_ENTITY2_t;
	void(*ADD_OWNED_EXPLOSION)(int entity, Vector3 Coords, int a, float a1, int b, int c, float b1) = (void(*)(int, Vector3, int, float, int, int, float))&ADD_OWNED_EXPLOSION_t;
	void(*set_entity_coords2)(int entity, Vector3 vec, bool, bool, bool, bool) = (void(*)(int, Vector3, bool, bool, bool, bool))&SET_ENTITY_COORDS2_t;
	void(*ATTACH_ENTITY_TO_ENTITY)(int entity, int entity2, int a, int b, int a1, int b1, int c, int d, int c1, int e, int f) = (void(*)(int, int, int, int, int, int, int, int, int, int, int))&ATTACH_ENTITY_TO_ENTITY_t;
	int(*CREATE_OBJECT)(int Hash, Vector3 Coords, int a, int b, int c) = (int(*)(int, Vector3, int, int, int))&CREATE_OBJECT_t;
	int(*GET_HASH_KEY)(const char * dvar) = (int(*)(const char *))&GET_HASH_KEY_t;
	Vector3(*GET_ENTITY_COORDS3)(int ped, bool vec) = (Vector3(*)(int, bool))&GET_ENTITY_COORDS3_t;
	int(*GET_PLAYER_PED3)(int PedID) = (int(*)(int))&GET_PLAYER_PED3_t;
	int(*CREATE_OBJECT2)(uint32_t Hash, Vector3 *Coords, int a, int b, int c, int d, int e) = (int(*)(uint32_t, Vector3 *Coords, int, int, int, int, int))&CREATE_OBJECT2_t;
	void(*ATTACH_ENTITY_TO_ENTITY2)(int Entity, int Entity2, int BoneIndex, Vector3 *O1, Vector3 *O2, int Zero, float Solid, float Dirty, int _Zero, int Two, int One) = (void(*)(int, int, int, Vector3 *O1, Vector3 *O2, int, float, float, int, int, int))&ATTACH_ENTITY_TO_ENTITY2_t;
	bool(*HAS_MODEL_LOADED)(uint32_t Hash) = (bool(*)(uint32_t))&HAS_MODEL_LOADED_t;
	void(*REQUEST_MODEL3)(uint32_t Hash) = (void(*)(uint32_t))&REQUEST_MODEL3_t;
	void(*SET_ENTITY_COLLISION2)(uint EntityHandle, bool Toggle) = (void(*)(uint, bool))&SET_ENTITY_COLLISION2_t;
	Vector3(*GET_ENTITY_COORDS4)(int id, bool) = (Vector3(*)(int, bool))&GET_ENTITY_COORDS4_t;
	int(*GET_PED_BONE_INDEX)(int PedID, int Bone) = (int(*)(int, int))&GET_PED_BONE_INDEX_t;
	bool(*DOES_ENTITY_EXIST)(uint VehID) = (bool(*)(uint))&DOES_ENTITY_EXIST_t;
	uint(*GET_PLAYER_PED2)(int Player) = (uint(*)(int))&GET_PLAYER_PED2_t;
	void(*APPLY_FORCE_TO_ENTITY_ALT)(int p0, int p1, float* Force, float* Pos, int p8, int p9, int p10, int p11, int p12, int p13) = (void(*)(int, int, float* Force, float* Pos, int, int, int, int, int, int))&_APPLY_FORCE_TO_ENTITY_ALT_t;
	float(*GET_ENTITY_SPEED)(int entity) = (float(*)(int))&GET_ENTITY_SPEED_t;
	int(*GET_VEHICLE_PED_IS_IN5)(int PLAYER_ID) = (int(*)(int))&GET_VEHICLE_PED_IS_IN5_t;
	void(*DRAW_LINE)(float* xyz1, float* xyz2, int r, int g, int b, int a) = (void(*)(float* xyz1, float* xyz2, int, int, int, int))&draw_line_t;
	void(*DRAW_RECT)(float x1, float y1, float x2, float y2, int r, int g, int b, int a) = (void(*)(float, float, float, float, int, int, int, int))&draw_rect_t;
	void(*_DRAW_RECT)(float* xyz1, float* xyz2, int r, int g, int b, int a) = (void(*)(float* xyz1, float* xyz2, int, int, int, int))&draw_rect_t;
	void(*APPLY_FORCE_TO_ENTITY)(int pedID, int index, Vector3 a, Vector3 b, int a1, int a2, int a3, int a4, int a5, int a6) = (void(*)(int, int, Vector3, Vector3, int, int, int, int, int, int))&APPLY_FORCE_TO_ENTITY_t;
	bool(*NETWORK_REQUEST_CONTROL_OF_ENTITY3)(int Entity) = (bool(*)(int))&NETWORK_REQUEST_CONTROL_OF_ENTITY3_t;
	bool(*NETWORK_HAS_CONTROL_OF_ENTITY)(uint VehID) = (bool(*)(uint))&NETWORK_HAS_CONTROL_OF_ENTITY_t;
	Vector3(*GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS2)(Entity entity, float xOffset, float yOffset, float zOffset) = (Vector3(*)(Entity entity, float xOffset, float yOffset, float zOffset))&GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS2_t;
	Vector3(*GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS1)(int ped, Vector3 coords) = (Vector3(*)(int, Vector3))&GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS1_t;

	Any(*NETWORK_CREATE_SYNCHRONISED_SCENE123)(float X, float Y, float Z, char* dict, char* anim, BOOL xAxis, BOOL yAxis, BOOL zAxis, BOOL p7) = (Any(*)(float X, float Y, float Z, char* dict, char* anim, BOOL xAxis, BOOL yAxis, BOOL zAxis, BOOL p7))&NETWORK_CREATE_SYNCHRONISED_SCENE123_t;

	bool(*GET_PED_LAST_WEAPON_IMPACT_COORD7)(Ped ped, Vector3* coords) = (bool(*)(Ped, Vector3 *))&GET_PED_LAST_WEAPON_IMPACT_COORD7_t;

	void(*NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE777)(int p0, int p1, char* animDictionary, char* animationName, float speed, float speedMultiplier, int duration, int flag, float playbackRate, BOOL lockX, BOOL lockY, BOOL lockZ) = (void(*)(int p0, int p1, char* animDictionary, char* animationName, float speed, float speedMultiplier, int duration, int flag, float playbackRate, BOOL lockX, BOOL lockY, BOOL lockZ))&NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE777_t;

	int(*DISPLAY_ONSCREEN_KEYBOARD)(int language, const char *gxtName, const char *unk1, const char *defaultText, const char *unk2, const char* unk3, const char* unk4, int maxMessageLen) = (int(*)(int, const char*, const char*, const char*, const char*, const char*, const char*, int))&DISPLAY_ONSCREEN_KEYBOARD_t;
	void(*APPLY_FORCE_TO_ENTITY2)(int entity, int forceType, float* xyz, float xRot, float yRot, float zRot, bool p8, bool isRel, bool ignoreUpVec, bool p11, bool p12, bool p13) = (void(*)(int, int, float*, float, float, float, bool, bool, bool, bool, bool, bool))&APPLY_FORCE_TO_ENTITY2_t;
	void(*APPLY_FORCE_TO_ENTITY3)(int entity, int forceType, float* x, float* y, float* z, float xRot, float yRot, float zRot, bool p8, bool isRel, bool ignoreUpVec, bool p11, bool p12, bool p13) = (void(*)(int, int, float*, float*, float*, float, float, float, bool, bool, bool, bool, bool, bool))&APPLY_FORCE_TO_ENTITY3_t;



	BOOL(*HAS_ANIM_DICT_LOADED)(char* AminSet) = (BOOL(*)(char* AminSet))&HAS_ANIM_DICT_LOADED_t;
	void(*REQUEST_ANIM_DICT)(char* AminSet) = (void(*)(char* AminSet))&REQUEST_ANIM_DICT_t;

	Vector3(*SET_ENTITY_COORDS7)(int id, Vector3 *c, int zero, int _zero, int zero_, int one) = (Vector3(*)(int, Vector3 *c, int, int, int, int))&SET_ENTITY_COORDS7_t;

	Any(*NETWORK_CREATE_SYNCHRONISED_SCENE)(float p0, float p1, float p2, float p3, float p4, float p5, BOOL p6, BOOL p7, BOOL p8, BOOL p9) = (Any(*)(float p0, float p1, float p2, float p3, float p4, float p5, BOOL p6, BOOL p7, BOOL p8, BOOL p9))&NETWORK_CREATE_SYNCHRONISED_SCENE_t;
	Any(*NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE)(int p0, int p1, char* dict, char* anim, float p4, float p5, float p6, float p7, float p8) = (Any(*)(int p0, int p1, char* dict, char* anim, float p4, float p5, float p6, float p7, float p8))&NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE_t;
	void(*NETWORK_START_SYNCHRONISED_SCENE)(int p0) = (void(*)(int p0))&NETWORK_START_SYNCHRONISED_SCENE_t;
	void(*NETWORK_STOP_SYNCHRONISED_SCENE)(Any p0) = (void(*)(Any p0))&NETWORK_STOP_SYNCHRONISED_SCENE_t;
	bool(*GET_PED_LAST_WEAPON_IMPACT_COORD2)(Ped ped, Vector3* coord) = (bool(*)(Ped, Vector3 *))&GET_PED_LAST_WEAPON_IMPACT_COORD2_t;
	Any(*NETWORK_CREATE_SYNCHRONISED_SCENE999999xx)(float x, float y, float z, char* dict, char* anim, BOOL p5, BOOL p6, BOOL p7, BOOL p8, BOOL p9) = (Any(*)(float x, float y, float z, char* dict, char* anim, BOOL p5, BOOL p6, BOOL p7, BOOL p8, BOOL p9))&NETWORK_CREATE_SYNCHRONISED_SCENE999999xx_t;
	int(*_GET_ENTITY_BONE_INDEX)(int entity, char *) = (int(*)(int, char *))&_GET_ENTITY_BONE_INDEX_t;
	int(*ATTACH_ENTITY)(int what_attach, int player_ped_id, int os, float* xyz, float * xyz_rotation, int p2, int p3, int p4, int p5, int p6, int p7) = (int(*)(int, int, int, float*, float*, int, int, int, int, int, int))&ATTACH_ENTITY_t;
	int(*ATTACH_ENTITY2)(int what_attach, int player_ped_id, int os, float* xyz, float* xyz_rotation, int p2, int p3, int p4, int p5, int p6, int p7) = (int(*)(int, int, int, float*, float*, int, int, int, int, int, int))&ATTACH_ENTITY_t;
	int(*ATTACH_ENTITY3)(int what_attach, int player_ped_id, int os, float x, float y, float z, float* xyz_rotation, int p2, int p3, int p4, int p5, int p6, int p7) = (int(*)(int, int, int, float x, float y, float z, float*, int, int, int, int, int, int))&ATTACH_ENTITY_t;

	Any(*NETWORK_CREATE_SYNCHRONISED_SCENE9999)(float x, float y, float z, float xRot, float yRot, float zRot, Any p6, Any p7, Any p8, Any p9, float p10, float p11) = (Any(*)(float x, float y, float z, float xRot, float yRot, float zRot, Any p6, Any p7, Any p8, Any p9, float p10, float p11))&NETWORK_CREATE_SYNCHRONISED_SCENE9999_t;
	Any(*NETWORK_CREATE_SYNCHRONISED_SCENE99999)(float p0, float p1, float p2, char p3, char p4, BOOL p5, BOOL p6, BOOL p7, BOOL p8, BOOL p9) = (Any(*)(float p0, float p1, float p2, char p3, char p4, BOOL p5, BOOL p6, BOOL p7, BOOL p8, BOOL p9))&NETWORK_CREATE_SYNCHRONISED_SCENE99999_t;

	Any(*NETWORK_CREATE_SYNCHRONISED_SCENE999999)(float x, float y, float z, char p3, char p4, BOOL p5, BOOL p6, BOOL p7, BOOL p8, BOOL p9) = (Any(*)(float x, float y, float z, char p3, char p4, BOOL p5, BOOL p6, BOOL p7, BOOL p8, BOOL p9))&NETWORK_CREATE_SYNCHRONISED_SCENE99999_t;
	int(*get_vehicle_ped_is_in)(int Entity, int) = (int(*)(int, int))&get_vehicle_ped_is_in_t;


	int(*NETWORK_CREATE_SYNCHRONISED_SCENE7)(float p0, float p1, float p2, float p3, float p4, float p5, int p6, int p7, int p8, float p9) = (int(*)(float p0, float p1, float p2, float p3, float p4, float p5, int p6, int p7, int p8, float p9))&NETWORK_CREATE_SYNCHRONISED_SCENE7_t;
	bool(*NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE7)(int p0, int p1, char* p2, char* p3, Any p4, Any p5, Any p6, Any p7, Any p8) = (bool(*)(int p0, int p1, char* p2, char* p3, Any p4, Any p5, Any p6, Any p7, Any p8))&NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE7_t;
	bool(*NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE8)(int p0, int p1, char* p2, char* p3, float p4, bool p5, bool p6, bool p7, bool p8) = (bool(*)(int p0, int p1, char* p2, char* p3, float p4, bool p5, bool p6, bool p7, bool p8))&NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE8_t;
	void(*SET_ENTITY_COORDS777)(int id, Vector3 *c, int zero, int _zero, int zero_, int one) = (void(*)(int, Vector3 *c, int, int, int, int))&SET_ENTITY_COORDS777_t;
	bool(*GET_PED_LAST_WEAPON_IMPACT_COORD777)(int ped, Vector3 * coords) = (bool(*)(int, Vector3 *))&GET_PED_LAST_WEAPON_IMPACT_COORD777_t;
	int(*CREATE_OBJECT777)(int Hash, Vector3 Coords, int a, int b, int c) = (int(*)(int, Vector3, int, int, int))&CREATE_OBJECT777_t;
	int(*GET_HASH_KEY777)(const char * dvar) = (int(*)(const char *))&GET_HASH_KEY777_t;
	/*
	opd_s CREATE_OBJECT_t = { 0x3F8E9C, TOC };
	int(*CREATE_OBJECT)(Hash ObjectHash, float x, float y, float z, int a, int b, int c) = (int(*)(int, float, float, float, int, int, int))&CREATE_OBJECT_t;*/
}
...
static LPCSTR weapon_array[] = {
	"Unarmed", "Animal","Couger","Knife","Night Stick","Hammer","Bat","Golf Club","Crow Bar","Pistol","Combat Pistol","AP Pistol","Pistol .50",
	"Micro SMG","SMG","Assault SMG","Assault Rifle","Carbin Rifle","Advance Rifle","MG","Combat MG","Pump Shotgun","Sawnoff Shotgun","Assault Shotgun",
	"Bullpup Shotgun","Stungun","Sniper Rifle","Heavy Sniper","Remote Sniper","Grenade Launcher","Grenade Launcher (Smoke)","RPG","Minigun",
	"Grenade","Sticky Bomb","Smoke Grenade","BZ Gas","Molotov","Fire Extinguisher","Jerry Can","Digi Scanner","Brief Case","Brief Case 2",
	"Ball","Flare","Bottle","Gusenberg","Special Carbin","Heavy Pistol", "SNS Pistol", "Bullpump Rifle","Dagger","Vintage Pistol","Firework",
	"Musket", "Heavy Shotgun","Marksman Rifle", "Homing Launcher", "Proximity Mine","Snow Ball", "Flare Gun", "Combat PDW", "Marksman Pistol",
	"Knuckle Dusters",
};
static const Hash weapon_hashes[] = {
	-1569615261, -100946242, 148160082, -1716189206, 1737195953,1317494643,-1786099057, 1141786504,-2067956739,453432689,1593441988,584646201,
	-1716589765,324215364,736523883,-270015777,-1074790547,-2084633992,-1357824103,-1660422300,2144741730,487013001,2017895192,-494615257,
	-1654528753,911657153,100416529,205991906,856002082,-1568386805,1305664598,-1312131151,1119849093,-1813897027,741814745,-37975472,
	-1600701090,615608432,101631238,883325847,-38085395,-2000187721,28811031,600439132,1233104067,4192643659,1627465347,3231910285,3523564046,
	3218215474,2132975508,2460120199,137902532,2138347493,2828843422,984333226,3342088282,1672152130,2874559379,126349499,1198879012,171789620,
	3696079510,3638508604,
};